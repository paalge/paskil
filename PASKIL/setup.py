...
if os.path.exists("/usr/share/pyshared/numpy/numarray/numpy/cfunc.h"):
    print "Found Numpy include file in strange location. Adding folder to include path."
...
if sys.argv.count('install') != 0:
    ...
    try:
        ...
        raise ImportError, "Could not import pyexiv2. Please ensure that it is correctly installed. See http://tilloy.net/dev/pyexiv2/index.htm"
