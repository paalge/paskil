...
struct bit_array_t
{
    ...
    unsigned long long int numBits;       /* number of bits in array */
};
...
bit_array_t *BitArrayCreate(unsigned long long int bits);
...
void BitArraySetBit(bit_array_t *ba, unsigned long long int bit);
void BitArrayClearBit(bit_array_t *ba, unsigned long long int bit);

/* raw bit access */
void *BitArrayGetBits(bit_array_t *ba);

/* bit test function */
int BitArrayTestBit(bit_array_t *ba, unsigned long long int bit);
